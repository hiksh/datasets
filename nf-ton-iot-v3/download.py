...
KAGGLE_DATASET = "seyhed/nf-ton-iot-v3"
REQUIRED_COLUMNS = ["Label", "Attack"]
...
def download():
    ...
    print("[NOTE] The Kaggle source may be the full NF-ToN-IoT-v3 dataset.")
    print("       The previously stored file was a reduced subset.")
