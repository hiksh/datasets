...
KAGGLE_DATASET = "dhoogla/cidds001"
INPUT_FILENAME = "CIDDS-001.csv"
OUTPUT_FILENAME = "Reformatted_CIDDS-001.csv"

# CIDDS-001 attack_type → kill-chain step
KILL_CHAIN = {
    "benign": 0,
    "portscan": 1,     # Reconnaissance
    "bruteforce": 4,   # Exploitation — credential brute-force
}
...
def process(input_filepath, output_filepath):
    ...
    # attack_type is most informative label; label col has 'benign'/'attacker'/'victim'
